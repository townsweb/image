...
class Decoder extends AbstractDecoder
{
    ...
    public function initFromImagick(\Imagick $object)
    {
        ...
        // Set the orientation from the source image's exif (if present)
        $object = $this->applyOrientation($object);
        // Set the colour profile from the source image
    ...
    /**
     * Modifies object by applying the exif orientation
     *
     * @param Imagick $object
     *
     * @return Imagick
     */
    private function applyOrientation(\Imagick $object)
    {
    ...
    {
        return base64_decode(self::SRGB_PROFILE);
    }
}
